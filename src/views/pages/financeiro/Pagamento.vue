...
export default {
  ...
  methods: {
    ...
    reprovarPedidoFiscal() {
      this.preloading = true;
      this.pedidoService
        .reprovarFinanceiroParaFiscal(this.novaMensagem, this.idPedido)
        .then((data) => {
    ...
    reprovarPedidoComprador() {
      this.preloading = true;
      this.pedidoService
        .reprovarFinanceiroParaComprador(this.novaMensagem, this.idPedido)
        .then((data) => {
    ...
    pago() {
      this.preloading = true;
      this.parcelaService.darBaixa(this.idParcela, this.form).then((data) => {
  ...
  <div class="grid">
    ...
    >
      <div class="grid">
        ...
        <div class="col-6">
          <Button
            @click.prevent="abrirChat(fiscal)"
            style="width: 100%"
            label="Reprovar e Enviar para Fiscal"
            icon="pi pi-times"
        ...
        <div class="col-6">
          <Button
            @click.prevent="this.displayDiretorio = true"
            style="width: 100%"
            label="Pago"
            icon="pi pi-check"
      ...
      <Splitter>
        ...
        >
          <iframe :src="pdfsrc" style="width: 100%; height: 900px; border: none">
        ...
        <SplitterPanel
          class="flex align-items-center justify-content-center splitter-panel"
        >
          <iframe :src="pdfsrcnota" style="width: 100%; height: 900px; border: none">
            Oops! ocorreu um erro.
          </iframe>
        </SplitterPanel>
        <SplitterPanel
          class="flex align-items-center justify-content-center splitter-panel"
        >
          <iframe :src="pdfsrcboleto" style="width: 100%; height: 900px; border: none">
            Oops! ocorreu um erro.
          </iframe>
        </SplitterPanel>
      </Splitter>
    ...
    <Dialog
      header="Tem certeza dessa operação?"
      v-model:visible="displayDiretorio"
      :modal="true"
      :style="{ width: '40%' }"
    >
      <div class="grid">
        <div class="field col-12 m-1">
          <span>Selecione o banco onde foi realizado esse pagamento?</span>
          <Dropdown
            class="mt-4"
            id="Link"
            v-model="form.banco"
        ...
        <div class="field col-6">
          <Button
            ...
            label="Cancelar"
            class="p-button-danger"
            @click="this.displayDiretorio = false"
          />
        </div>
      </div>
    </Dialog>
        ...
        <div class="p-fluid formgrid grid mb-5">
          <div class="field col-2 md:col-2">
            <label for="firstname2"
              >Dt de Início <span class="obrigatorio">*</span></label
            >
            <Calendar
              dateFormat="dd/mm/yy"
              v-tooltip.top="'Selecione a data inicial'"
          ...
          <div class="field col-2 md:col-2">
            ...
            <Calendar
              dateFormat="dd/mm/yy"
              v-tooltip.top="'Selecione a data final'"
              v-model="form.dt_fim"
              showIcon
              iconDisplay="input"
            />
          ...
          <div class="field col-2 md:col-2">
            ...
            <Button
              label="Limpar"
              @click.prevent="buscaPedidosHoje()"
              icon="pi pi-trash"
              class="p-button-danger"
            />
          </div>
        ...
        >
          ...
          <Column field="Valor" header="Valor" :sortable="true" class="w-2">
            <template #body="slotProps">
              ...
              {{
                slotProps.data.valor_parcela.toLocaleString("pt-BR", {
                  style: "currency",
                  currency: "BRL",
                })
              }}
