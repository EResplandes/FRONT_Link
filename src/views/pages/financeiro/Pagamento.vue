...
<template>
    ...
    <div class="grid">
        ...
        <Dialog header="Tem certeza dessa operação?" v-model:visible="displayDiretorio" :modal="true" :style="{ width: '40%' }">
            <div class="grid">
                <div class="field col-12 m-1">
                    <span>Selecione o banco onde foi realizado esse pagamento?</span>
                    <Dropdown class="mt-4" id="Link" v-model="form.banco" style="width: 100%" :options="bancos" optionLabel="banco" placeholder="Selecione..."></Dropdown>
                </div>
