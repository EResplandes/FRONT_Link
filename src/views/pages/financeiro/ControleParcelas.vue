...
<template>
    ...
    <div class="grid">
        ...
        <Dialog v-model:visible="display" header="Flex Scroll" :style="{ width: '75vw' }" maximizable modal :contentStyle="{ height: '300px' }">
            ...
            <template #footer>
                <Button label="Fechar" icon="pi pi-check" @click="dialogVisible = false" />
            </template>
        </Dialog>
        ...
        <div class="col-12">
            ...
            <h4 class="px-3">Controle de Pagamentos</h4>
