...
export default {
  ...
  methods: {
    ...
    reprovarParcelas() {
      this.preloading = true;
      this.parcelaService
        .reprovarParcelasComprador(this.idPedido, this.novaMensagem)
        .then((data) => {
...
<template>
  ...
  <div class="grid">
    ...
    <!-- Geração de Parcelas -->
    <Dialog
      v-model:visible="displayParcelas"
      header="PARCELAS"
      :style="{ width: '60%' }"
      maximizable
      modal
      ...
      <div class="grid">
        ...
        <div class="col-12">
          <div class="p-fluid formgrid grid mb-5 p-3">
            <div class="field col-4 md:col-6">
              <label for="firstname2"
                >Quantidade de Parcelas: <span class="obrigatorio">*</span></label
              >
              <InputNumber
          ...
          <div class="parcelas-container">
            <div
              v-for="(parcela, index) in geracaoParcelas"
              :key="index"
              class="p-fluid formgrid grid mb-5 px-5"
            >
              <div class="col-12">
    ...
    >
      <div class="grid">
        <div class="col-6">
          <Button
            @click.prevent="abrirChat()"
            style="width: 100%"
            label="REPROVAR E ENVIAR PARA COMRPADOR"
            icon="pi pi-times"
        ...
        <div class="col-3">
          <Button
            style="width: 100%"
            @click.prevent="abrirModalNovaParcela()"
            label="Gerar Parcela"
            class="p-button-info"
          />
        </div>
        ...
        <div class="col-3">
          <Button
            style="width: 100%"
            @click.prevent="validarParcelas()"
            label="VALIDAR PARCELAS"
            class="p-button-success"
          />
        </div>
        ...
        <div class="col-12">
          <Button
            style="width: 100%"
            @click.prevent="visualizarPdfs()"
            label="VISUALIZAR PEDIDO, BOLETO E NOTA"
            class="p-button-info"
          />
        </div>
        ...
        <div style="height: 900px" class="col-7 timeline-container">
          <iframe :src="pdfsrcboleto" style="width: 100%; height: 650px; border: none">
              ...
              <Column field="..." header="..." class="w-3">
                <template #body="slotProps">
                  ...
                  <Button
                    icon="pi pi-pencil"
                    severity="secondary"
                    @click.prevent="abrirModalAlterarParcelas(slotProps.data)"
                  />
                </template>
              </Column>
            </DataTable>
    ...
    >
      <div class="grid">
        <div class="col-12">
          ...
          />
          <Button
            @click.prevent="reprovarParcelas()"
            label="Enviar"
    ...
    >
      <div class="grid">
        ...
        <div class="field col-12 md:col-4">
          ...
          <InputNumber
            v-tooltip.top="'Digite o valor da parcela'"
            v-model="dadosAlterar.valor"
        ...
        <div class="field col-12 md:col-4">
          ...
          <Calendar
            dateFormat="dd/mm/yy"
            v-tooltip.top="'Selecione a data de vencimento da parcela'"
            v-model="dadosAlterar.dt_vencimento"
            showIcon
            iconDisplay="input"
          />
        </div>
    ...
    <Dialog
      v-model:visible="displayPedidoBoletoNota"
      maximizable
      modal
      header="Header"
      :style="{ width: '90%' }"
    ...
    >
      <Splitter>
        ...
        >
          <iframe :src="pdfsrc" style="width: 100%; height: 1200px; border: none">
            Oops! ocorreu um erro.
          </iframe>
        </SplitterPanel>
        <SplitterPanel
          class="flex align-items-center justify-content-center splitter-panel"
        >
          <iframe :src="pdfsrcnota" style="width: 100%; height: 1200px; border: none">
            Oops! ocorreu um erro.
          </iframe>
        </SplitterPanel>
        <SplitterPanel
          class="flex align-items-center justify-content-center splitter-panel"
        >
          <iframe :src="pdfsrcboleto" style="width: 100%; height: 1200px; border: none">
            Oops! ocorreu um erro.
          </iframe>
        </SplitterPanel>
      </Splitter>
            ...
            <template #body="slotProps">
              ...
              <div class="grid">
                <div class="col-3 md:col-3">
                  <Button
                    @click.prevent="visualizar(slotProps.data.id, slotProps.data)"
                    icon="pi pi-eye"
                    class="p-button-info"
                  />
                </div>
