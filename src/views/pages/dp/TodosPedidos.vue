...
export default {
    ...
    mounted: function () {
        ...
        this.dpService.listarPedidos().then((data) => {
...
<template>
    ...
    <div class="grid">
        ...
        <div class="col-12">
            <div style="margin-top: 10px" class="header-padrao">TODOS PEDIDOS <br /><span style="font-size: 10px">( Limitado a os últimos 500 pedidos )</span></div>
