...
export default {
  ...
  methods: {
    ...
    buscaPedidos() {
      ...
      this.pedidoService
        .buscaReprovados(localStorage.getItem("local_id"))
        .then((data) => {
          this.pedidos = data.pedidos;
          this.preloading = false;
        });
    ...
    enviarMensagem() {
      this.preloading = true;
      this.pedidoService
        .respondePedidoReprovado(this.pdf, this.novaMensagem, this.id_pedido)
        .then((data) => {
          if (data.resposta == "Mensagem enviada com sucesso!") {
            ...
            this.showError(
              "Ocorreu algum problema, entre em contato com o Administrador"
            );
          }
        });
    },
...
<template>
  ...
  <div class="grid">
    ...
    >
      <div class="grid">
        <div class="col-12">
          ...
          />
          <Button
            @click.prevent="this.displayAnexo = true"
    ...
    <!-- Anexo -->
    <Dialog
      header="Insira novo Anexo"
      v-model:visible="displayAnexo"
      :style="{ width: '30%' }"
      :modal="true"
    >
      ...
      <div>
        <Button
          @click.prevent="this.displayAnexo = false"
          label="Salvar"
          class="mr-2 mt-3 p-button-success col-12"
        />
      </div>
    ...
    <div class="col-12">
      ...
      <div class="card">
        ...
        >
          ...
          <Column
            field="Nº Ped. Protheus"
            header="Nº Ped. Protheus"
            :sortable="true"
            class="w-1"
          >
            <template #body="slotProps">
              <span class="p-column-title">Nº Ped. Protheus</span>
