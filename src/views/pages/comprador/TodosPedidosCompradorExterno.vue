...
<template>
  ...
  <div class="grid">
    ...
    <Dialog
      ...
      :modal="true"
    >
      <iframe :src="pdfsrc" style="width: 100%; height: 700px; border: none">
    ...
    <div class="col-12">
      ...
      <div class="p-fluid formgrid grid justify-content-center">
        <div class="field col-2 md:col-2">
          ...
          <Calendar
            dateFormat="dd/mm/yy"
            v-tooltip.top="'Selecione a data de vencimento'"
          ...
          >
            ...
            <template #filter="{ filterModel, filterCallback }">
              <InputText
                ...
                placeholder="Procurar pela Dt. de Inclusão"
              />
            </template>
          </Column>
          <Column
          ...
          <Column field="valor_formatado" header="Valor" style="min-width: 12rem">
            ...
            <template #filter="{ filterModel, filterCallback }">
              <InputText
                ...
                @input="filterCallback()"
                class="p-column-filter"
                placeholder="Procurar pelo Valor"
              />
            </template>
          </Column>
          ...
          <Column field="descricao" header="Fornecedor" style="min-width: 12rem">
            ...
            <template #filter="{ filterModel, filterCallback }">
              <InputText
                ...
                @input="filterCallback()"
                class="p-column-filter"
                placeholder="Procurar pelo fornecedor"
              />
            </template>
          </Column>
          ...
          <Column field="local.local" header="Local" style="min-width: 12rem">
            ...
            <template #filter="{ filterModel, filterCallback }">
              <InputText
                ...
                @input="filterCallback()"
                class="p-column-filter"
                placeholder="Procurar pela Descrição"
              />
            </template>
          </Column>
          ...
          <Column field="..." header="..." :sortable="true" class="w-2">
            <template #body="slotProps">
              ...
              <div class="flex gap-2">
                ...
                <Button
                  v-if="
                    ['Reprovado', 'Aprovado com Ressalva'].includes(
                ...
                <Button
                  v-if="
                    ['Aprovado', 'Aprovado com Ressalva'].includes(
                      slotProps.data.status.status
                    )
                  "
