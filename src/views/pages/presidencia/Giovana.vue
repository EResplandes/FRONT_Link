...
export default {
  ...
  methods: {
    ...
    reprovarPedido() {
      this.pedidoService
        .reprovarGiovana(this.idPedido, this.novaMensagem)
        .then((data) => {
          if (data.resposta == "Pedido aprovado com sucesso!") {
            this.showSuccess("Pedido aprovado com sucesso!");
            this.buscaPedidos();
    ...
    >
      <div class="flex justify-content-center">
        <div class="flex-1 m-1">
          <Button
            @click.prevent="aprovarPedido(1)"
            icon="pi pi-check"
            label="Aprovar e Enviar Dr. Emival"
        ...
        <div class="flex-1 m-1">
          <Button
            @click.prevent="aprovarPedido(2)"
            icon="pi pi-check"
            label="Aprovar e Enviar Financeiro"
            class="p-button-info"
            style="width: 100%"
          />
        </div>
      ...
      <div class="grid">
        <div class="col-12">
          ...
          <InputText
            class="col-12"
            type="text"
            v-model="this.novaMensagem"
            placeholder="Digite a mensagem..."
          />
          <Button
            @click.prevent="reprovarPedido()"
            label="Reprovar e enviar mensagem"
            ...
            <template #body="slotProps">
              ...
              <div class="grid">
                <div class="col-4 md:col-4 mr-3">
                  <Button
                    @click.prevent="visualizar(slotProps.data)"
                    icon="pi pi-eye"
                    class="p-button-info"
                  />
                </div>
